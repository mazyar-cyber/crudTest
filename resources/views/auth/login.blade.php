...
<head>
    ...
    <title>Login Page - Rayankar - Bootstrap HTML admin template</title>
                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="index.html">
                            ...
                            <h2 class="brand-text text-primary ms-1">Rayankar</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Welcome to Rayankar! 👋</h2>
                                ...
                                <form method="POST" action="{{ route('login') }}" class="auth-login-form mt-2">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror"
                                            ...
                                            autofocus="" tabindex="1" name="email" />
                                ...
                                <div class="auth-footer-btn d-flex justify-content-center"><a class="btn btn-facebook"
                                        href="{{ route('register') }}"><i data-feather="facebook"></i></a><a
