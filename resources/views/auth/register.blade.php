                                ...
                                <form class="auth-register-form mt-2" method="POST"
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="register-username" type="text"
                                            placeholder="johndoe" @error('name') is-invalid @enderror
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="email"
                                            ...
                                            id="register-email" type="text" name="email"
                                    ...
                                    <div class="mb-1">
                                        <label class="form-label" for="register-password">Password Confirm</label>
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input
                                                class="form-control form-control-merge @error('password') is-invalid @enderror"
